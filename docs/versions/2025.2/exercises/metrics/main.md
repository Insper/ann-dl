...
**Activity: Understanding Metrics for Machine Learning**

This activity is designed to test your skills in evaluating machine learning models using various metrics.
