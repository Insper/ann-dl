...
--8<-- "docs/2025.2/classes/data/salmon_vs_seabass_1.py"
```
/// caption
...
```python exec="1" html="1"
--8<-- "docs/2025.2/classes/data/salmon_vs_seabass_2.py"
```
...
--8<-- "docs/2025.2/classes/data/iris_data.py"
```
...
```python exec="1" html="1"
--8<-- "docs/2025.2/classes/data/iris_visualization.py"
```
/// caption
...
```python exec="1" html="1"
--8<-- "docs/2025.2/classes/data/distributions.py"
```
/// caption
