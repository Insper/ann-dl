...
--8<-- "docs/2025.2/classes/deep-learning/dense.md"

---

### B. Convolutional

--8<-- "docs/2025.2/classes/deep-learning/convolutional.md"
...
--8<-- "docs/2025.2/classes/deep-learning/pooling.py"
```
...
--8<-- "docs/2025.2/classes/deep-learning/lstm.md"
...
```pyodide install="pandas,scikit-learn" exec="on" html="1"
--8<-- "docs/2025.2/classes/deep-learning/embedding.py"
```
...
```pyodide install="pandas,scikit-learn" exec="on" html="1"
--8<-- "docs/2025.2/classes/deep-learning/attention.py"
```
...
```pyodide install="pandas,scikit-learn" exec="on" html="1"
--8<-- "docs/2025.2/classes/deep-learning/normalization.py"
```
...
--8<-- "docs/2025.2/classes/deep-learning/dropout.md"
...
```pyodide install="pandas,scikit-learn" exec="on" html="1"
--8<-- "docs/2025.2/classes/deep-learning/flatten.py"
```
...
```pyodide install="pandas,scikit-learn" exec="on" html="1"
--8<-- "docs/2025.2/classes/deep-learning/activation.py"
```
