...
- **Image Encoder**: Typically a [Vision Transformer (ViT)](../vision-transformers/index.md) or a modified ResNet that processes images into fixed-dimensional embeddings (e.g., 512 or 768 dimensions).
...
--8<-- "docs/2026.2/classes/clip/quiz.md"
