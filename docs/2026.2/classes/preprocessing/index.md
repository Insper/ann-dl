...
=== "Result"
    ...
    ```python exec="on" html="0"
    --8<-- "docs/2026.2/classes/preprocessing/invest-preprocessing.py"
    ```
    
=== "Original"

    ```python exec="on" html="0"
    --8<-- "docs/2026.2/classes/preprocessing/invest-original.py"
    ```
...
```python
--8<-- "docs/2026.2/classes/preprocessing/iris-pca.py"
```

Now, the same example using scikit-learn is shown below:

```python
--8<-- "docs/2026.2/classes/preprocessing/iris-pca-sklearn.py"
``` -->
...
--8<-- "docs/2026.2/classes/preprocessing/normalization-vs-standardization.md"
...
--8<-- "docs/2026.2/classes/preprocessing/quiz.md"
